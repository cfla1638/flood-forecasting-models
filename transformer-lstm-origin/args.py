...
class Args(object):
    ...
    def set_train_args(self):
        ...
        self.parser.add_argument("--train_start_date", type=str, default='1999-10-01', help="Training start time")
        self.parser.add_argument("--train_end_date", type=str, default='2008-09-30', help="Training end time")
        self.parser.add_argument("--val_start_date", type=str, default='1995-10-01', help="Validating start time")
        self.parser.add_argument("--val_end_date", type=str, default='1999-09-30', help="Validating end time")
