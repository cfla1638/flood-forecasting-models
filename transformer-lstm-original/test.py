...
# python -u test.py --use_GPU --GPU_id=0 --num_workers=2 --start_time=2009-10-01T00 --end_time=2011-09-30T00  --model_path=./checkpoints/epoch4.pth --basin_list=time_bad_basin_list.txt --test_basin_by_basin
